...
function EmojiPickerSearch({
  ...
  return (
    <div
      className={cn("flex h-9 items-center gap-2 border-b border-secondary px-3", className)}
...
function EmojiPickerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "max-w-(--frimousse-viewport-width) flex w-full min-w-0 items-center gap-1 border-t border-secondary p-2",
        className,
      )}
